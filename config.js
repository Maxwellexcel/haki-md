...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'HAKI',
    AUTOMUTE_MSG: process.env.AUTOMUTE_MSG || '_Group locked 🔐 only admins can send messages.!_\n_(Change this by setting var AUTOMUTE_MSG)_',
    AUTOUNMUTE_MSG: process.env.AUTOUNMUTE_MSG || '_Group successfully opened✅!_\n_(Change this by setting var AUTOUNMUTE_MSG)_',
    ANTILINK_MSG: process.env.ANTILINK_MSG || '_Link Not Allowed!_\n_(Change this by setting var ANTILINK_MSG)_',
    BOT_INFO: process.env.BOT_INFO || 'Haki-md;haki;2348121373516;https://i.imgur.com/6oRG106.jpeg',
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '2348121373516',
       DEBUG: DEBUG
};
